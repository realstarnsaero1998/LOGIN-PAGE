...
<title>Nandha InfoTech | Subjects</title>
...
<div class="col-sm-12">
<div class="text-center">
<h1 class="sc_title sc_title_regular sc_title_bold">EXAM PREPARATION MADE SIMPLE!</h1>
<h3 class="sc_title sc_title_regular"> Subjects Offered</h3>
</div>
</div>
</div>
<!-----------------------------------------------Testname----------------------------------------------------->
  <?php  
     $result = mysql_query("SELECT * FROM `subject` WHERE `mian_id`='$id'");
            ?>                    
...
<a title="Take Test" href="stdtest.php?subid=<?= $r['subid'] ?> ">Take Test</a>
</div>
</div>
