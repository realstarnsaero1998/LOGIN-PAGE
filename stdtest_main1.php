...
<h3 class="sc_title sc_title_regular"> Tests Offered</h3>
    ...
    <form id="stdtest" action="stdtest.php" method="post">
         ...
         <?php
                                ...
                                $result = executeQuery("select t.*,s.subname from test as t, subject as s where s.subid=t.subid and t.subid=$subid and CURRENT_TIMESTAMP<t.testto and t.totalquestions=(select count(*) from question where testid=t.testid)");
                                 //editing components
...
<a title="Take Test" href="stdtest.php?testcode=<?= htmlspecialchars_decode($r['testname'], ENT_QUOTES); /*-------------------mailer------------------*/
