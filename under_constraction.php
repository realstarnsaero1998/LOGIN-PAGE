...
<title>Nandha InfoTech | Site under construction</title>
...
<span class="current">Under Constraction</span>
</div>
<h3 class="pageTitle h3">Under Constraction</h3>
</div>
</div>
</div>
</section>
...
<div>Estimated time remaining before launching the site </div>
</div>
</div>
<div class="col-sm-12">
<div class="sc_emailer inputSubmitAnimation sc_aligncenter sFocus rad4 opened margin_top_small">
<form>
<input type="text" class="sInput" name="email" value="" placeholder="Please, enter you email address." class="sInput">
</form>
